...
import { FiLayout, FiShield, FiFileText, FiUsers, FiPieChart, FiLogOut, FiMenu, FiUser, FiCreditCard, FiFolder } from "react-icons/fi";
...
export const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { path: "/admin/users", label: "Users", icon: <FiUser className="h-5 w-5" /> },
        ...
        { path: "/admin/payments", label: "Payments", icon: <FiCreditCard className="h-5 w-5" /> },
        { path: "/admin/claims", label: "Claims", icon: <FiFileText className="h-5 w-5" /> },
        { path: "/admin/documents", label: "Documents", icon: <FiFolder className="h-5 w-5" /> },
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center space-x-3 rounded-xl px-4 py-3 text-sm font-semibold transition-all duration-200 ${
                                    isActive 
                                    ? "bg-sky-600/10 text-sky-700 shadow-sm border-l-4 border-sky-600 pl-3" 
